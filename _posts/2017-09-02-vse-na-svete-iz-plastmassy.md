...
<div main row>
    <div class="col-xs-12 col-sm-6">
	    <p><img src="https://res.cloudinary.com/milkleaks/image/upload/v1518867324/01_rtuntu.png" alt="Anet A8"></p>
	    <p caption>Существуют три вещи на которые можно смотреть бесконечно: как горит огонь, течет вода и печатает 3D принтер.</p>
    </div>
    <div class="col-xs-12 col-sm-6">
        <p><img src="https://res.cloudinary.com/milkleaks/image/upload/v1518867325/02_ex8uxh.png" alt="Anet A8"></p>
        <p caption>Готовая тестовая модель из комплектного, прозрачного PLA пластика на фоне <s>всякого мусора</s> музыкального усилителя.</p>
    </div>
</div>
...
<div main row>
    <div class="col-xs-12 col-sm-6">
        <p><img src="https://res.cloudinary.com/milkleaks/image/upload/v1518867325/03_ccqldb.png" alt="Anet A8"></p>
        <p caption>Печатаем <a href="https://www.thingiverse.com/thing:6076">октокота</a> из ABS пластика.</p>
    </div>
    <div class="col-xs-12 col-sm-6">
        <p><img src="http://res.cloudinary.com/milkleaks/image/upload/v1518867326/04_rs0op1.png" alt="Anet A8"></p>
        <p caption>Готовый октокот, требует доработки и покраски, но и без этого очень мил.</p>
    </div>
</div>
