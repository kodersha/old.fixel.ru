...
{% cloudinary src:v1518867324/01_rtuntu.png alt:"Существуют три вещи на которые можно смотреть бесконечно: как горит огонь, течет вода и печатает 3D принтер." %}

{% cloudinary src:v1518867325/02_ex8uxh.png alt:"Готовая тестовая модель из комплектного, прозрачного PLA пластика на фоне музыкального усилителя." %}
...
{% cloudinary src:v1518867325/03_ccqldb.png alt:"Печатаем [октокота](https://www.thingiverse.com/thing:6076) из ABS пластика." %}

{% cloudinary src:v1518867326/04_rs0op1.png alt:"Готовый октокот, требует доработки и покраски, но и без этого очень мил." %}
