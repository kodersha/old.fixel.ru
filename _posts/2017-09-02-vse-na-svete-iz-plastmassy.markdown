...
{% image src:044.jpg alt:"Существуют три вещи на которые можно смотреть бесконечно: как горит огонь, течет вода и печатает 3D принтер." %}

{% image src:045.jpg alt:"Готовая тестовая модель из комплектного, прозрачного PLA пластика на фоне музыкального усилителя." %}
...
{% image src:046.jpg alt:"Печатаем [октокота](https://www.thingiverse.com/thing:6076) из ABS пластика." %}

{% image src:047.jpg alt:"Готовый октокот, требует доработки и покраски, но и без этого очень мил." %}
